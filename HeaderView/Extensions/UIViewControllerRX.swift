//
//  UIViewControllerRX.swift
//  HeaderView
//
//  Created by Hussein Jaber on 24/4/19.
...
public extension Reactive where Base: UIImageView {
    var didChangeImage: ControlEvent<Void> {
        let source = self.methodInvoked(#selector(setter: Base.image)).map {_ in }
